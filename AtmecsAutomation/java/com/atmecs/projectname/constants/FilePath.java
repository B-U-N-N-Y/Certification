...
public class FilePath {
	...
	public final static String LOCATOR_FILE= LOCATOR_HOME+"//filename";
	public final static String VALIDATION_FILE= RESOURCES_HOME+"testdata"+File.separator+"//filename";
